...
################################################################
# This is a generated script based on design: zynqmp_top
#
...
proc create_root_design { parentCell } {
  ...
  set axi_bram [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 axi_bram ]
  ...
  # Create instance: axi_hpm0_addr, and set properties
  set axi_hpm0_addr [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_hpm0_addr ]
  set_property -dict [ list \
  ...
  # Create instance: rst_zynqmp_ps_159M, and set properties
  set rst_zynqmp_ps_159M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_zynqmp_ps_159M ]

  # Create instance: zynqmp_ps, and set properties
  set zynqmp_ps [ create_bd_cell -type ip -vlnv xilinx.com:ip:zynq_ultra_ps_e:3.1 zynqmp_ps ]
  set_property -dict [ list \
   ...
   CONFIG.PSU_MIO_TREE_PERIPHERALS {Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO0 MIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#GPIO0 MIO#I2C 1#I2C 1#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#UART 1#UART 1#UART 0#UART 0#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#MDIO 3#MDIO 3} \
   ...
   CONFIG.PSU__CRL_APB__PCAP_CTRL__DIVISOR0 {4} \
   CONFIG.PSU__CRL_APB__PCAP_CTRL__FREQMHZ {200} \
   CONFIG.PSU__CRL_APB__PCAP_CTRL__SRCSEL {RPLL} \
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__ACT_FREQMHZ {159.998} \
  ...
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTA [get_bd_intf_pins axi_bram/BRAM_PORTA] [get_bd_intf_pins axi_bram_ctrl/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_hpm0_addr_M00_AXI [get_bd_intf_pins axi_bram_ctrl/S_AXI] [get_bd_intf_pins axi_hpm0_addr/M00_AXI]
  connect_bd_intf_net -intf_net zynqmp_ps_M_AXI_HPM0_LPD [get_bd_intf_pins axi_hpm0_addr/S00_AXI] [get_bd_intf_pins zynqmp_ps/M_AXI_HPM0_LPD]

  # Create port connections
  connect_bd_net -net rst_zynqmp_ps_159M_interconnect_aresetn [get_bd_pins axi_hpm0_addr/ARESETN] [get_bd_pins rst_zynqmp_ps_159M/interconnect_aresetn]
  connect_bd_net -net rst_zynqmp_ps_159M_peripheral_aresetn [get_bd_pins axi_bram_ctrl/s_axi_aresetn] [get_bd_pins axi_hpm0_addr/M00_ARESETN] [get_bd_pins axi_hpm0_addr/S00_ARESETN] [get_bd_pins rst_zynqmp_ps_159M/peripheral_aresetn]
  connect_bd_net -net zynqmp_ps_pl_clk0 [get_bd_pins axi_bram_ctrl/s_axi_aclk] [get_bd_pins axi_hpm0_addr/ACLK] [get_bd_pins axi_hpm0_addr/M00_ACLK] [get_bd_pins axi_hpm0_addr/S00_ACLK] [get_bd_pins rst_zynqmp_ps_159M/slowest_sync_clk] [get_bd_pins zynqmp_ps/maxihpm0_lpd_aclk] [get_bd_pins zynqmp_ps/pl_clk0]
  connect_bd_net -net zynqmp_ps_pl_resetn0 [get_bd_pins rst_zynqmp_ps_159M/ext_reset_in] [get_bd_pins zynqmp_ps/pl_resetn0]

  # Create address segments
  create_bd_addr_seg -range 0x00001000 -offset 0x80002000 [get_bd_addr_spaces zynqmp_ps/Data] [get_bd_addr_segs axi_bram_ctrl/S_AXI/Mem0] SEG_axi_bram_ctrl_Mem0
